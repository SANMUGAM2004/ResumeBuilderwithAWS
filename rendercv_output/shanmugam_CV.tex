...
\patchcmd{\ps@customFooterStyle}{\thepage}{
    \color{gray}\textit{\small shanmugam - Page \thepage{} of \pageref*{LastPage}}
...
\begin{document}
    ...
    \begin{header}
        ...
        \normalsize
        \mbox{
            {\footnotesize\faMapMarker*}\hspace*{0.13cm}coimbatore
        }
        \kern 0.5 cm
        \mbox{
            \hrefWithoutArrow{mailto:hmsanmugam@gmail.com}{{\footnotesize\faEnvelope[regular]}\hspace*{0.13cm}hmsanmugam@gmail.com}
        }
        \kern 0.5 cm
        \mbox{
            \hrefWithoutArrow{tel:+91-1234-567-890}{{\footnotesize\faPhone*}\hspace*{0.13cm}+91 1234 567 890}
        }
        \kern 0.5 cm
        \mbox{
            \hrefWithoutArrow{https://yourwebsite.com/}{{\footnotesize\faLink}\hspace*{0.13cm}yourwebsite.com}
        }
        \kern 0.5 cm
        \mbox{
            \hrefWithoutArrow{https://linkedin.com/in/www.hmsanmugam.com}{{\footnotesize\faLinkedinIn}\hspace*{0.13cm}www.hmsanmugam.com}
        }
        \kern 0.5 cm
        \mbox{
            \hrefWithoutArrow{https://github.com/github.com}{{\footnotesize\faGithub}\hspace*{0.13cm}github.com}
        }
        \kern 0.5 cm
    \end{header}
    ...
    \section{Education}
        ...
        \begin{threecolentry}{\textbf{BTech}}{
            ...
            \textbf{Karpagam Institute of Technology}, IT
            \begin{highlights}
                \item Education is important
            \end{highlights}
        \end{threecolentry}
